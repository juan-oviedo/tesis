...
\hl{En definitiva, el objetivo de esta tesis es comparar diferentes aproximaciones basadas en LLMs para las tareas de clasificación y adaptación de textos en inglés, evaluando sus fortalezas, limitaciones y posibles aplicaciones en escenarios educativos reales.}
...
\begin{itemize}
\item En el Capítulo 1, presentamos la introducción general, junto con la motivación y la estructura del trabajo.
...
\item En el Capítulo 3, describimos la arquitectura propuesta, detallando el stack tecnológico utilizado, tanto en términos de modelos como de hardware.
\item En el Capítulo 4, presentamos los conjuntos de datos empleados, incluyendo datasets de textos clasificados con nivel CEFR y un dataset de adaptaciones, además de las modificaciones realizadas sobre los conjuntos preexistentes.
...
\item En el Capítulo 7, presentamos las conclusiones generales del trabajo, discutiendo los aportes alcanzados y las limitaciones encontradas.
\item Finalmente, en el Capítulo 8, delineamos posibles líneas de trabajo futuro, proponiendo extensiones y mejoras que podrían explorarse en investigaciones posteriores.
\end{itemize}