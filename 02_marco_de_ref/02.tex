...
\paragraph{Natural Language Processing (NLP) - Procesamiento de Lenguaje Natural (PLN).\cite{nlp}}
...
\paragraph{Large Language Models (LLMs) - Grandes Modelos de Lenguaje.\cite{llms}}
...
\paragraph{Pre-Trained Models - Modelos Preentrenados.\cite{pretrained}}
...
\paragraph{Tokens - Unidades de procesamiento.\cite{Grefenstette1999}}
...
\paragraph{Prompt - Instrucción de entrada.\cite{Schulhoff2025}}
...
\paragraph{Context Window - Ventana de contexto.\cite{context_window}}
...
\paragraph{Prompt Engineering - Ingeniería de prompts.\cite{Brown2020}}
...
\paragraph{In-Context Learning - Aprendizaje en contexto.\cite{Brown2020}}
...
\paragraph{Fine-Tuning - Ajuste fino. \cite{finetuning_1, finetuning_2}}
...
\paragraph{Common European Framework of Reference for Languages (CEFR) - Marco Común Europeo de Referencia para las Lenguas.\cite{cefr}}
...
\paragraph{Automatic Readability Assessment (ARA) - Evaluación Automática de Legibilidad.\cite{Feng2010}}
